...
<div class="container-fluid">
        <div class="row">
            <div class="col-5 mx-auto py-5">
                <form action="models/registracija.php" method="POST" id="regForm">
                    ...
                    <p class='text-center my-3'>Imate nalog?
                        <a href="index.php?page=logovanje" class='ml-2 text-secondary'>Prijavi se.</a>
                    </p>
                    <input type="submit" value="Registruj se" id="btnReg" class="btn btn-outline-light form-control my-2">
                </form>
